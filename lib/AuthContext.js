...
export function AuthProvider({ children }) {
  ...
  const buscarUsuario = useCallback(async (authUserId) => {
    ...
    if (!data) { setUsuario(null); setErroCadastro("Seu login não está vinculado a nenhum cadastro. Fale com o administrador."); return; }
...
export const ROTULO_PERFIL = {
  ...
  lider: "Líder Local", funcionario: "Funcionário", terceiro: "Terceiro", visualizador: "Visualizador",
};
