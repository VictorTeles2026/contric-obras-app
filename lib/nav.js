...
// ordem do menu lateral do painel desktop
export const NAV_PAINEL = [
  ...
  { href: "/relatorios", label: "Relatórios", icone: "relatorio" },
  { href: "/documentos", label: "Documentos", icone: "pasta" },
  { href: "/clientes", label: "Clientes", icone: "predio", perfis: ["master", "gerente", "coordenador"] },
